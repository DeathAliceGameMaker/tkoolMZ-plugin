...
(() => {
	...
	{
		if (parameters.ActiveMode && $gameVariables.value(parameters.BattleSpeed_ActiveMode) > 0)
			battleSpeed_active = $gameVariables.value(parameters.BattleSpeed_ActiveMode);
		if (parameters.WaitMode && $gameVariables.value(parameters.BattleSpeed_WaitMode) > 0)
